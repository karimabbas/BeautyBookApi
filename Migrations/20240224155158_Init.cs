    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "Company_2024/Feb/Sat|05:51:57"),
                    Phonenumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Logo = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "/images/logoCompany.webp"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpenUntil = table.Column<TimeSpan>(type: "time", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyOpenHours", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyOpenHours_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CompanyId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BaseUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<string>(type: "VARCHAR(200)", maxLength: 200, nullable: true, defaultValue: "/images/profile.webp"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyLikes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyLikes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompanyLikes_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyLikes_CompanyId",
                table: "CompanyLikes",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyLikes_UserId",
                table: "CompanyLikes",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyOpenHours_CompanyId",
                table: "CompanyOpenHours",
                column: "CompanyId");
